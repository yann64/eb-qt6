...
Extern "C" Lib "ebqt6shim"
    ...
    Declare Sub eb_qt6_combobox_insert_item(ByVal combo AS ANY PTR, ByVal index AS INTEGER, ByVal text AS ZSTRING)
    Declare Function eb_qt6_combobox_item_text(ByVal combo AS ANY PTR, ByVal index AS INTEGER) AS ANY PTR
End Extern
